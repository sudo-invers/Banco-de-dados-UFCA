...
# connect = ConnectDatabase() # Isso impede o uso do login
# inserçoes
class SaveBD:
    ...
    def save(self):
        self.connect.cur.execute(self.query, self.data)
...
class InsertUser:
    def __init__(self, email, senha, perfil):
        self.sql_insert = (
            """INSERT INTO USUARIO(email, senha, tipo_usuario) VALUES(%s, %s, %s)"""
        )
